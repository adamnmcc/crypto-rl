...
class BinanceData_dl:
    ...
    def __init__(self, start_date: str, end_date: str, data_dir: str, ticker_list: list, time_resolution: str = '15m'):

        self.start_date = start_date
        self.end_date = end_date
        self.data_dir = data_dir
        self.ticker_list = ticker_list
        self.interval = time_resolution
        
        

    def binance_klines_fromurl(self, symbol, interval, start, end, scaling=1, limit=5000):
    ...
    def fetch_data(self, scaling: int = 1) -> pd.DataFrame:
        ...
        for tic in self.ticker_list:
            ...
            df = self.binance_klines_fromurl(tic, self.interval, self.start_date, self.end_date, scaling)
            df = df[col_use]
